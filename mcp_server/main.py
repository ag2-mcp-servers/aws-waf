...
@app.post(
    ...
    tags=['match_set_operations', 'comprehensive_match_set_management'],
    security=[
...
@app.post(
    ...
    tags=['geo_match_set_management', 'comprehensive_match_set_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['ip_set_management', 'comprehensive_match_set_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['regex_match_set_management', 'comprehensive_match_set_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=[
        'comprehensive_match_set_management',
        'match_set_operations',
        'regex_match_set_management',
    ],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    tags=['rule_management', 'web_acl_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['size_constraint_set_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['sql_injection_match_set_management', 'comprehensive_match_set_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['rule_management', 'web_acl_management', 'change_token_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['rule_management', 'comprehensive_match_set_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['size_constraint_set_management', 'comprehensive_match_set_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=[
        'sql_injection_match_set_management',
        'comprehensive_match_set_management',
        'match_set_operations',
    ],
    security=[
...
@app.post(
    ...
    tags=['comprehensive_match_set_management', 'match_set_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    description=""" <note> <p>This is <b>AWS WAF Classic</b> documentation. For more information, see <a href="https://docs.aws.amazon.com/waf/latest/developerguide/classic-waf-chapter.html">AWS WAF Classic</a> in the developer guide.</p> <p> <b>For the latest version of AWS WAF</b>, use the AWS WAFV2 API and see the <a href="https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html">AWS WAF Developer Guide</a>. With the latest version, AWS WAF has a single set of endpoints for regional and global use. </p> </note> <p>Returns an array of <a>RuleSummary</a> objects.</p> """,
    tags=['comprehensive_match_set_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['rate_based_rule_management', 'rule_management', 'web_acl_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
